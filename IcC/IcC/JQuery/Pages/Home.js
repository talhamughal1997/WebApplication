...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        $(".ClassRooms #btn-Submit").click(function () {

            $(".ClassRooms .Message_Box").animate({ opacity: '1' });
...
function About_Page() {
    ...
    if (wS == (hT + hH - wH)) {
        ...
        $(".Vision-Box").prev(this).stop().animate({ marginTop: '4vh', marginLeft: '10vh', opacity: '1', minWidth: '40%', minHeight: '40vh' }, 'slow', function () {
            $(".Vision-Box").next(this).stop().animate({ marginTop: '4vh', marginLeft: '10vh', opacity: '1', minWidth: '40%', minHeight: '40vh' }, 'slow')
        });
...
function Services_Page() {
    ...
    if (wS >= (hT + hH - wH)) {
        ...
        $(".Services-Page h1").stop().animate({ opacity: '0', fontSize: "0vh" }, 'fast', function () {
...
function Admin_Slider()
{
    ...
    $("#Admin-Pic-1").animate({opacity:'1'},2000,
       
        function(){$("#Admin-Pic-1").animate({opacity:'0'},1000,
            
            function(){$("#Admin-Pic-2").animate({opacity:'1'},2000,
              
                function(){$("#Admin-Pic-2").animate({opacity:'0'},1000,
                    
                    function(){$("#Admin-Pic-3").animate({opacity:'1'},2000,
...
function Comments_Slider()
{
    
    $("#Comment_img_1").animate({ opacity: '1' }, 2000, function () {
        $("#Comment_img_1").animate({ opacity: '0' }, 1000, function () {
            $("#Comment_img_2").animate({ opacity: '1' }, 2000, function () {
                $("#Comment_img_2").animate({ opacity: '0' }, 1000, function () {
                    $("#Comment_img_3").animate({ opacity: '1' }, 2000, function () {
                        $("#Comment_img_3").animate({ opacity: '0' }, 1000, function () {
                            $("#Comment_img_4").animate({ opacity: '1' }, 2000, function () {
                                $("#Comment_img_4").animate({ opacity: '0' }, 1000, function () {
                                    $("#Comment_img_5").animate({ opacity: '1' }, 2000, function () {
                                        $("#Comment_img_5").animate({ opacity: '0' }, 1000, function () {
                                            $("#Comment_img_6").animate({ opacity: '1' }, 2000, function () {
                                                $("#Comment_img_6").animate({ opacity: '0' }, setInterval(Comments_Slider(),1500))
                                            })
                                        })
                                    })
                                })
